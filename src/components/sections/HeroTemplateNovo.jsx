...
function HeroTemplateNovo({
  ...
  return (
    ...
    >
      <section className="relative w-full pt-[80px] phone2:pt-[110px] tablet1:pt-[134px] tablet2:pt-[137px] desktop1:pt-[175px] desktop2:pt-[190px] pb-[64px] desktop1:pb-[96px] flex items-center justify-center overflow-hidden font-mainFont">
